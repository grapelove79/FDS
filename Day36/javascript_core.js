...
})(this); // this는 window이다.쎄미콜론을 붙이는 습관이 좋다. 왜냐면 다음 함수와 붙어서 한문장처럼 보이니까.

// console.log(yamoo9); // [ERROR] yamoo9 is not defined. 전역은 메모리에 남게 된다.
...
(function(global){
	'use strict';
	// 숫자 객체 생서자를 사용하여 숫자 1부터 10까지를 변수 num1~num10에 생성하여라.
	// 단, num1 ~ num10에는 숫자 값이 담겨야 한다.

	//(new Date()).getDay(); // 명확해서 ()로 감쌌다.
	...
	// 불리언 객체 생성자를 사용하여 블리언 true, false로 연속되는 변수 boo1~boo10에 생성하여라.
	// 단, boo1 ~ boo10에는 블리언 값이 담겨야 한다.
