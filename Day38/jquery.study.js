...
(function($){
  ...
  // Object.prototype.toString은 객체만이 가지고 있는 속성인데 객체 어떤게 들어올 모르니까 call(data)을 사용해서 toString을 빌려와 쓰는것이다. toString을 null하고 undefinded를 객체처럼 사용가능하게 끔, 그 타입을 반환하게 끔 도와주는 역활을 한다.(null하고 undefinded를 어떻게 객체처럼 사용할까해서)
