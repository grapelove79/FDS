...
var modal_title_case 		= "modal-title";
var modal_title_content = "modal Window";
var modal_desc_class 		= "modal-desc";

var modal_template = [
	'<div class="'+ modal_class +'">',
	'<h2 class="'+ modal-title_class +'">' + modal_title_content +'</h2>',
	'<p class="'+ modal-desc +'">Modal Windwo Content...</p>',
	'<button class="modal-cta" type="button">send massage</button>',
	'<button cass="modal-class" type="button" aria-label="close modal windwo">x</button>',
	'</div>'
].join('');

// var i = 0;

body.innerHTML += modal_template; // modal_template을 기존 html뒤에 붙여줘
